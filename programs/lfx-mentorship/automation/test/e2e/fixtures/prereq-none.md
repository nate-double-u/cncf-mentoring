...
Disposable e2e test proposal for the custom-prerequisite validation hotfix. It carries a no custom prerequisite (box unchecked, fields empty) so validation must pass. Safe to close and delete after the run.
